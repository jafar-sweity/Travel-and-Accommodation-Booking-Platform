...
namespace TravelAndAccommodationBookingPlatform.Application.Tests.Queries.Cities
{
    public class GetTrendingCitiesQueryHandlerTests
    {
        ...
        public async Task Handle_ShouldReturnMappedCities_WhenCountIsValid()
        {
            ...
            _mockCityRepository.Setup(r => r.GetTopMostVisitedCitiesAsync(3)).ReturnsAsync(mockCities);
            ...
            _mockCityRepository.Verify(r => r.GetTopMostVisitedCitiesAsync(3), Times.Once);
