...
namespace TravelAndAccommodationBookingPlatform.Application.Tests.Commands.Hotles
{
    public class CreateHotelCommandHandlerTests
    {
        ...
        public async Task Handle_ShouldCreateHotel_WhenAllIsValid()
        {
            ...
            _mockOwnerRepository.Setup(r => r.ExistsByPredicateAsync(It.IsAny<Expression<Func<Owner, bool>>>())).ReturnsAsync(true);
            _mockCityRepository.Setup(r => r.ExistsByPredicateAsync(It.IsAny<Expression<Func<City, bool>>>())).ReturnsAsync(true);
            ...
            _mockHotelRepository.Setup(r => r.AddAsync(mappedHotel)).ReturnsAsync(createdHotel);
            ...
            _mockHotelRepository.Verify(r => r.AddAsync(mappedHotel), Times.Once);
