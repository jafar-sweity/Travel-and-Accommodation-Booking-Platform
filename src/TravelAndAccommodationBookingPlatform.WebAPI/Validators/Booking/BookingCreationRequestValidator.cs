...
namespace TravelAndAccommodationBookingPlatform.WebAPI.Validators.Booking
{
    public class BookingCreationValidatior : AbstractValidator<BookingCreationRequestDto>
    {
        public BookingCreationValidatior()
        {
            RuleFor(x => x.RoomId)
